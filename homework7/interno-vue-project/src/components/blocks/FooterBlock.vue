    ...
    <div class="container">
      <div class="footer">
        <div class="footer__interno">
          ...
          <div class="footer__interno_pages">
            <div class="footer__interno_pages-title">
              Страницы
            </div>
          ...
          <div class="footer__interno_contact">
            <div class="footer__interno_pages-title footer__interno_contact-title">
              Контакты
            </div>
            <div class="footer__interno_interno-text footer__interno_contact-text">
              55 East Birchwood Ave. Brooklyn, New York 11201 <br><br>
              contact@interno.com <br><br>
              (123) 456 - 7890
            </div>
          </div>
        </div>
